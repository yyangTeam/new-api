...
func IsRequestPolicyOption(key string) bool {
	...
	switch key {
	case "CheckSensitiveEnabled", "CheckSensitiveOnPromptEnabled", "SensitiveWords", "AutomaticEnableChannelEnabled", "ChannelDisableThreshold", "monitor_setting.auto_test_channel_enabled", "monitor_setting.auto_test_channel_minutes", "monitor_setting.channel_test_concurrency", "monitor_setting.channel_test_mode", "monitor_setting.channel_error_notify_enabled", "monitor_setting.channel_consecutive_error_threshold", "monitor_setting.channel_error_rate_enabled", "monitor_setting.channel_error_rate_threshold", "monitor_setting.channel_error_rate_window_minutes", "monitor_setting.channel_error_rate_min_requests", "RetryTimes", "AutomaticRetryStatusCodes", "AutomaticDisableChannelEnabled", "AutomaticDisableStatusCodes", "AutomaticDisableKeywords":
		return true
	}
	return false
}
