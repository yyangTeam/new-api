...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/latest-release", middleware.AdminAuth(), controller.GetLatestRelease)
		apiRouter.POST("/system/update", middleware.RootAuth(), controller.PerformUpdate)
		apiRouter.POST("/system/restart", middleware.RootAuth(), controller.RestartService)
		apiRouter.POST("/system/rollback", middleware.RootAuth(), controller.RollbackService)
		apiRouter.GET("/system/rollback/versions", middleware.RootAuth(), controller.ListRollbackVersions)
		apiRouter.POST("/system/rollback/version", middleware.RootAuth(), controller.RollbackToVersion)
		...
		tokenRoute.Use(middleware.TokenOperationAudit())
		{
			...
			tokenRoute.POST("/batch/create", middleware.CriticalRateLimit(), controller.CreateTokenBatch)
