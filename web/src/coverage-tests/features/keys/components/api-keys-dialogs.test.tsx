...
vi.mock('@/features/keys/components/api-keys-batch-add-drawer', () => ({
  ApiKeysBatchAddDrawer: (props: { open: boolean }) => (
    <div data-testid='batch-add' data-open={props.open} />
  ),
}))
vi.mock('@/features/keys/components/api-keys-delete-dialog', () => ({
  ApiKeysDeleteDialog: () => <div data-testid='delete-dialog' />,
}))
vi.mock('@/features/keys/components/api-keys-mutate-drawer', () => ({
