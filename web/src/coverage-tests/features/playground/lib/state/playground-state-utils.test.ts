...
vi.mock('@/features/playground/lib/storage/storage', () => ({
  loadConfig: vi.fn(() => ({})),
...
describe('getInitialPlaygroundConfig', () => {
  ...
  test('merges storage values over defaults', async () => {
    const { loadConfig } = await import('@/features/playground/lib/storage/storage')
...
describe('getInitialParameterEnabled', () => {
  ...
  test('merges storage values over defaults', async () => {
    const { loadParameterEnabled } = await import('@/features/playground/lib/storage/storage')
...
describe('getInitialMessages', () => {
  ...
  test('returns messages from storage when available', async () => {
    ...
    const { loadMessages } = await import('@/features/playground/lib/storage/storage')
