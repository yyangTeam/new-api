import {
  ...
  saveMessages,
  clearPlaygroundData,
} from '@/features/playground/lib/storage/storage'

vi.mock('@/features/playground/constants', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@/features/playground/constants')>()
  return {
    ...actual,
    STORAGE_KEYS: {
