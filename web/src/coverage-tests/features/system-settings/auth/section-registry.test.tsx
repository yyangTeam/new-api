...
vi.mock('@/features/system-settings/auth/basic-auth-section', () => ({
  BasicAuthSection: () => 'BasicAuthSection',
}))
vi.mock('@/features/system-settings/auth/bot-protection-section', () => ({
  BotProtectionSection: () => 'BotProtectionSection',
}))
vi.mock('@/features/system-settings/auth/custom-oauth/custom-oauth-section', () => ({
  CustomOAuthSection: () => 'CustomOAuthSection',
}))
vi.mock('@/features/system-settings/auth/oauth-section', () => ({
  OAuthSection: () => 'OAuthSection',
}))
vi.mock('@/features/system-settings/auth/passkey-section', () => ({
