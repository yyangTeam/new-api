...
vi.mock('@/features/system-settings/components/settings-accordion', () => ({
  SettingsAccordion: ({ title, children }: any) =>
    React.createElement('div', { 'data-testid': 'accordion', title }, children),
}))

vi.mock('@/features/system-settings/components/settings-form-layout', () => ({
...
import { JsonToggleSection } from '@/features/system-settings/content/json-toggle-section'
