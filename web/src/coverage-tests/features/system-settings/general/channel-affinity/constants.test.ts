import { RULE_TEMPLATES, makeUniqueName, cloneTemplate } from '@/features/system-settings/general/channel-affinity/constants'
import type { RuleTemplate } from '@/features/system-settings/general/channel-affinity/constants'
