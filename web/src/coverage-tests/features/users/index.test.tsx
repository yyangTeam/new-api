...
vi.mock('@/features/users/components/users-delete-dialog', () => ({
  UsersDeleteDialog: () => <div data-testid='delete-dialog' />,
}))
vi.mock('@/features/users/components/users-mutate-drawer', () => ({
  UsersMutateDrawer: (props: { open: boolean }) => (
    <div data-testid='mutate-drawer' data-open={props.open} />
  ),
}))
vi.mock('@/features/users/components/users-primary-buttons', () => ({
  UsersPrimaryButtons: () => <div data-testid='primary-buttons' />,
}))
vi.mock('@/features/users/components/users-provider', () => ({
